...
roads_london = shapefile.Reader("E:/python/yhy/finalProject/shapefile/gadm36_CHN_0.shp")

# open circle polygon with pyshp
clip_area = shapefile.Reader("E:/python/yhy/finalProject/shapefile/gadm36_CHN_1.shp")
...
pyshp_writer = shapefile.Writer("E:/python/yhy/finalProject/shapefile/roads_clipped.shp")
...
# # save to disk
# pyshp_writer.save("E:/python/yhy/finalProject/shapefile/roads_clipped.shp")
